...
def road_lines_eval(dilation_parameter):
	...
	for file_number in range (1,41):
	    img_link = 'Data/images/road_%d.png' %file_number
	    annotation_link = 'Data/annotations/road_%d.txt' %file_number
	...
	global_true_positive = global_true_positive/40*100
	global_false_positive = global_false_positive/40*100
	global_true_negative = global_true_negative/40*100
	global_false_negative = global_false_negative/40*100
	global_lines_detected = global_lines_detected/40*100
...
def roc_curve_road():
	...
	for dilation_parameter in range (1,6):
	    true_pos, false_pos,_,_,_ = road_lines_eval(dilation_parameter)
